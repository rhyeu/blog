...
## "The Diculty in Designing Shewhart $\bar{X}$ and X Control Charts with Estimated Parameters(Saleh et al., 2015)"
...
where $\bar{R} = (\sum_{i=1}^m R_i) / m, \, \bar{S} = (\sum_{i=1}^m S_i) / m, \, S_{pooled} = ((\sum_{i=1}^m S_i^2) / m)^{1/2}, \, v = m(n-1)$
...
- 실험 설계
  ...
  ![](https://raw.githubusercontent.com/rhyeu/blog/master/content/img/Saleh_2015_table1.PNG)
...
- m이 커지면 커질 수록 이상값에 수렴하고 추정치간의 차이도 줄어듦.
 ...
 ![](https://raw.githubusercontent.com/rhyeu/blog/master/content/img/Saleh_2015_table2.PNG)
...
- 현실적으로 이상적인 값에 도달할 수 없음
 ...
 ![](https://raw.githubusercontent.com/rhyeu/blog/master/content/img/Saleh_2015_figure1.PNG){ width=80% } 

- $ARL_0$의 변동이 매우 큼

  ![](https://raw.githubusercontent.com/rhyeu/blog/master/content/img/Saleh_2015_figure2.PNG){ width=80% } 

![](https://raw.githubusercontent.com/rhyeu/blog/master/content/img/Saleh_2015_figure3.PNG){ width=80% } 

- $\hat{\sigma}$가 $\hat{\mu}$보다 $ARL$을 추정하는 데 더 영향을 많이 미침.(Figure 2,3)


![](https://raw.githubusercontent.com/rhyeu/blog/master/content/img/Saleh_2015_figure4.PNG){ width=80% } 


![](https://raw.githubusercontent.com/rhyeu/blog/master/content/img/Saleh_2015_figure5.PNG){ width=80% } 

- $m=50$, $m=100$이 되어도 $ARL_0$ 변동이 매우 큰 것을 확인


![](https://raw.githubusercontent.com/rhyeu/blog/master/content/img/Saleh_2015_table3_1.PNG)

 
![](https://raw.githubusercontent.com/rhyeu/blog/master/content/img/Saleh_2015_table3_2.PNG) 

 - 목표로 하는 $ARL_0$이 커질수록 $SDARL$가 $ARL_0$의 10%가 되게 하는 $m$의 값도 커짐.
 - 다시말해, $ARL_0$의 값이 커질수록 안정적인 추정값을 확보하기 위한 샘플 사이즈도 커짐.

![](https://raw.githubusercontent.com/rhyeu/blog/master/content/img/Saleh_2015_figure6.PNG)
...
![](https://raw.githubusercontent.com/rhyeu/blog/master/content/img/Saleh_2015_table4.PNG)
