---
title: Multinomial classification with tidymodels and volcano eruption
author: 류성균
date: '2020-09-21'
slug: multinomial-classification-with-tidymodels-and-volcano-eruption
categories:
  - Today I learn
tags:
  - Rstat
...
The biggest thing I know about volcanoes is the [Ring of Fire](https://en.wikipedia.org/wiki/Ring_of_Fire) "fire" and there it is!
...
# treat inbalance
```{r}
# install.packages("themis") # for smote
library(themis)
...
ggplot() +
  ...
  labs(fill = "Percent Classified correctly")
```