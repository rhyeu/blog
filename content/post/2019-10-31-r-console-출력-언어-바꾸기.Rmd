---
title: "R console 출력 언어 바꾸기"
author: "류성균"
date: '2019-10-31'
slug: r-console-출력-언어-바꾸기
tags: Rconsole
categories: Tips
---
...
1. '관리자 권한으로 실행'된 텍스트 에디터에서 *'C:/Program Files/R/R-3.6.1/etc/Rconsole'* 파일을 연다.

2. 중간 부분에 있는 메시지 언어 설정 내용을 아래와 같이 바꿔준다.
```
